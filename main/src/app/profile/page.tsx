...
export default function ProfileScreen() {
    ...
    const [editData, setEditData] = useState({ phone_number: '', department: '' });
    ...
    useEffect(() => {
        ...
        fetch('/api/students/me', { headers: { 'Authorization': `Bearer ${token}` } })
            ...
            .then(data => {
                setStudentInfo(data);
                setEditData({ phone_number: data.phone_number || '', department: data.department || '' });
            })
            .catch(console.error);
    }, [token]);
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            {/* Main Content Area */}
            <div className="flex-1 px-6 md:px-10 pb-24 space-y-8 max-w-4xl mx-auto w-full">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    {/* Activity Stats & Actions Section */}
                    <div className="space-y-4">
